...
Examples:
  ...
  pocket-relay-miner relay jsonrpc --app-priv-key <hex> --service anvil --node localhost:9090 --chain-id poktroll

  # Load test with 1000 concurrent requests
  pocket-relay-miner relay jsonrpc --load-test -n 1000 --concurrency 100 --app-priv-key <hex> --service anvil

  # WebSocket relay test
  pocket-relay-miner relay websocket --app-priv-key <hex> --service anvil --relayer-url ws://localhost:8080
`,
...
func RelayCmd() *cobra.Command {
	...
	relayCmd.PersistentFlags().StringVar(&relayServiceID, "service", "", "Service ID (e.g., anvil, eth-mainnet)")
